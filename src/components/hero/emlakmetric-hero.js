/*
 * Emlakmetric — izometrik maket hero'su (bağımsız sürüm)
 * Bağımlılık yok. Tarayıcıda doğrudan çalışır.
 *
 *   <link href="https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@400;500;700&family=Space+Mono:wght@400;700&display=swap" rel="stylesheet">
 *   <script src="emlakmetric-hero.js"></script>
 *   <script>EmlakmetricHero.mount(document.querySelector('#hero-canvas'));</script>
 *
 * React:
 *   useEffect(() => EmlakmetricHero.mount(ref.current).destroy, []);
 *
...
(function (root) {
  ...
  root.EmlakmetricHero = { mount: mount };
})(typeof window !== 'undefined' ? window : this);

if (typeof module !== 'undefined' && module.exports) module.exports = { mount: window.EmlakmetricHero.mount };
