    ...
    >
      <defs>
        ...
        <linearGradient id="tower-grad" x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset="50%" stopColor="var(--primary)" stopOpacity="0.30" />
          <stop offset="100%" stopColor="var(--primary)" stopOpacity="0.12" />
        </linearGradient>
        ...
        <linearGradient id="mosque-dome" x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset="100%" stopColor="var(--primary)" stopOpacity="0.30" />
        </linearGradient>
      ...
      <g>
        ...
        {/* Tower windows */}
        <line data-draw x1="148" y1="165" x2="162" y2="165" stroke="var(--primary)" strokeWidth="0.5" strokeOpacity="0.5" />
        <line data-draw x1="148" y1="170" x2="162" y2="170" stroke="var(--primary)" strokeWidth="0.5" strokeOpacity="0.5" />
        <line data-draw x1="148" y1="175" x2="162" y2="175" stroke="var(--primary)" strokeWidth="0.5" strokeOpacity="0.5" />
        ...
        {/* Window glow */}
        <rect data-fade x="150" y="162" width="3" height="3" rx="0.5" fill="var(--primary)" opacity="0.5" />
        <rect data-fade x="156" y="168" width="3" height="3" rx="0.5" fill="var(--primary)" opacity="0.4" />
      </g>
      ...
      <g>
        ...
        <path
          ...
          stroke="var(--primary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.7"
        />
        {/* Dome fill gradient */}
        <path data-fade d="M300 210 Q300 150 380 120 Q460 150 460 210 Z" fill="url(#mosque-dome)" />
        {/* Secondary domes */}
        <path data-draw d="M290 210 Q290 180 320 170 Q350 180 350 210" stroke="var(--primary)" strokeWidth="1" strokeOpacity="0.5" />
        <path data-draw d="M410 210 Q410 180 440 170 Q470 180 470 210" stroke="var(--primary)" strokeWidth="1" strokeOpacity="0.5" />
        {/* Dome crescent */}
        <circle data-draw cx="380" cy="115" r="4" stroke="var(--primary)" strokeWidth="1.2" fill="none" opacity="0.7" />
        <path data-draw d="M380 108 L380 102" stroke="var(--primary)" strokeWidth="1" opacity="0.7" />
        {/* Minaret details */}
        <circle data-draw cx="268" cy="90" r="2" stroke="var(--primary)" strokeWidth="0.8" fill="none" opacity="0.6" />
        <circle data-draw cx="490" cy="90" r="2" stroke="var(--primary)" strokeWidth="0.8" fill="none" opacity="0.6" />
        {/* Building body fill */}
        <path data-fade d="M260 300 L260 210 L500 210 L500 300 Z" fill="url(#building-grad)" />
        {/* Windows on mosque body */}
        <g data-fade opacity="0.5">
          <rect x="310" y="230" width="8" height="14" rx="4" fill="none" stroke="var(--primary)" strokeWidth="0.6" />
          <rect x="330" y="230" width="8" height="14" rx="4" fill="none" stroke="var(--primary)" strokeWidth="0.6" />
          <rect x="350" y="230" width="8" height="14" rx="4" fill="none" stroke="var(--primary)" strokeWidth="0.6" />
          <rect x="400" y="230" width="8" height="14" rx="4" fill="none" stroke="var(--primary)" strokeWidth="0.6" />
          <rect x="420" y="230" width="8" height="14" rx="4" fill="none" stroke="var(--primary)" strokeWidth="0.6" />
          <rect x="440" y="230" width="8" height="14" rx="4" fill="none" stroke="var(--primary)" strokeWidth="0.6" />
        </g>
        {/* Interior glow through windows */}
        <g data-fade>
          <rect x="312" y="233" width="4" height="8" rx="2" fill="var(--primary)" opacity="0.25" />
          <rect x="352" y="233" width="4" height="8" rx="2" fill="var(--primary)" opacity="0.20" />
          <rect x="422" y="233" width="4" height="8" rx="2" fill="var(--primary)" opacity="0.25" />
        </g>
      </g>
      ...
      <g>
        ...
        <path data-draw d="M566 155 Q690 230 814 155" stroke="var(--primary)" strokeWidth="2.2" strokeLinecap="round" strokeOpacity="0.7" />
        <path data-draw d="M566 155 Q690 215 814 155" stroke="var(--primary)" strokeWidth="1.2" strokeLinecap="round" strokeOpacity="0.4" />
        {/* Vertical cable hangers */}
        {[600, 625, 650, 675, 700, 725, 750, 775].map((x) => (
          <line key={x} data-draw x1={x} y1={260} x2={x} y2={155 + Math.sin(((x - 566) / 248) * Math.PI) * 75} stroke="var(--primary)" strokeWidth="0.5" strokeOpacity="0.3" />
        ))}
        {/* Bridge deck */}
        ...
        <g data-fade>
          {[580, 620, 660, 700, 740, 780, 820].map((x) => (
            <circle key={x} cx={x} cy="256" r="1.5" fill="var(--primary)" opacity="0.5" />
          ))}
        </g>
      </g>
      ...
      <g>
        ...
        {/* Spire */}
        <path data-draw d="M894 210 L894 195 L892 192 L894 186 L896 192 L894 195" stroke="var(--primary)" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.7" />
        {/* Windows */}
        <rect data-draw x="886" y="245" width="6" height="8" rx="3" fill="none" stroke="var(--primary)" strokeWidth="0.6" strokeOpacity="0.6" />
        <rect data-draw x="896" y="245" width="6" height="8" rx="3" fill="none" stroke="var(--primary)" strokeWidth="0.6" strokeOpacity="0.6" />
        {/* Water platform */}
        <ellipse data-draw cx="894" cy="300" rx="30" ry="6" fill="none" stroke="var(--primary)" strokeWidth="0.8" strokeOpacity="0.3" />
        {/* Lighthouse glow */}
        <circle data-fade cx="894" cy="186" r="3" fill="var(--primary)" opacity="0.5" filter="url(#glow)" />
      </g>

      {/* Modern skyscrapers — Levent/Maslak district */}
      <g>
        {/* Tallest tower - Sapphire */}
        <path data-draw d="M1010 300 L1010 90 L1014 80 L1018 72 L1022 80 L1026 90 L1026 300" stroke="var(--primary)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.7" />
        ...
        <g data-fade opacity="0.4">
          {[120, 150, 180, 210, 240, 270].map((y) => (
            <line key={y} x1="1012" y1={y} x2="1024" y2={y} stroke="var(--primary)" strokeWidth="0.7" />
          ))}
        </g>
        {/* Lit windows */}
        <g data-fade>
          <rect x="1013" y="135" width="3" height="3" rx="0.5" fill="var(--primary)" opacity="0.45" />
          <rect x="1019" y="165" width="3" height="3" rx="0.5" fill="var(--primary)" opacity="0.35" />
          <rect x="1013" y="195" width="3" height="3" rx="0.5" fill="var(--primary)" opacity="0.40" />
          <rect x="1019" y="225" width="3" height="3" rx="0.5" fill="var(--primary)" opacity="0.30" />
        </g>
        ...
        <path data-draw d="M1040 135 L1050 128 L1060 135" stroke="var(--primary)" strokeWidth="1" strokeOpacity="0.5" />
        {/* Lit windows */}
        <g data-fade>
          <rect x="1045" y="155" width="3" height="3" rx="0.5" fill="var(--primary)" opacity="0.35" />
          <rect x="1051" y="185" width="3" height="3" rx="0.5" fill="var(--primary)" opacity="0.30" />
        </g>
        ...
        {/* Slim tower */}
        <path data-draw d="M1110 300 L1110 110 L1116 100 L1122 110 L1122 300" stroke="var(--primary)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.7" />
        <path data-fade d="M1110 300 L1110 110 L1122 110 L1122 300 Z" fill="url(#skyscraper-grad)" />

        {/* Antenna light on tallest */}
        <circle data-fade cx="1018" cy="72" r="3" fill="var(--primary)" opacity="0.7" filter="url(#glow)" />
        {/* Secondary antenna light */}
        <circle data-fade cx="1116" cy="100" r="2" fill="var(--primary)" opacity="0.5" filter="url(#glow)" />
      </g>
      ...
      <g data-fade>
        ...
        <path d="M30 265 Q40 258 50 265" fill="url(#dome-grad)" stroke="var(--primary)" strokeWidth="0.5" strokeOpacity="0.3" />
      </g>

      {/* Trees / vegetation silhouettes */}
      <g data-fade opacity="0.2">
        <circle cx="200" cy="290" r="12" fill="var(--primary)" opacity="0.4" />
        <circle cx="215" cy="285" r="10" fill="var(--primary)" opacity="0.35" />
        <circle cx="225" cy="292" r="8" fill="var(--primary)" opacity="0.3" />
        <circle cx="530" cy="288" r="10" fill="var(--primary)" opacity="0.35" />
        <circle cx="545" cy="292" r="8" fill="var(--primary)" opacity="0.3" />
        <circle cx="840" cy="290" r="9" fill="var(--primary)" opacity="0.3" />
        <circle cx="855" cy="286" r="11" fill="var(--primary)" opacity="0.35" />
      </g>
      ...
      <path
        ...
        stroke="var(--primary)" strokeWidth="2" strokeLinecap="round" strokeOpacity="0.5"
      />
      ...
      <g clipPath="url(#water-clip)" opacity="0.2" data-fade>
        <g transform="translate(0, 600) scale(1, -1)">
          ...
          <path d="M260 300 L260 210 L500 210 L500 300 Z" fill="var(--primary)" opacity="0.3" />
          ...
          <rect x="1008" y="250" width="20" height="50" fill="var(--primary)" opacity="0.4" />
          <rect x="1038" y="260" width="24" height="40" fill="var(--primary)" opacity="0.3" />
          <rect x="1108" y="255" width="16" height="45" fill="var(--primary)" opacity="0.4" />
        </g>
      </g>

      {/* Shimmering water ripples */}
      <g data-fade opacity="0.12">
        <line x1="100" y1="320" x2="160" y2="320" stroke="var(--primary)" strokeWidth="0.8" />
        <line x1="300" y1="330" x2="380" y2="330" stroke="var(--primary)" strokeWidth="0.6" />
        <line x1="500" y1="315" x2="560" y2="315" stroke="var(--primary)" strokeWidth="0.8" />
        <line x1="650" y1="325" x2="730" y2="325" stroke="var(--primary)" strokeWidth="0.6" />
        <line x1="850" y1="318" x2="920" y2="318" stroke="var(--primary)" strokeWidth="0.8" />
      ...
      <g data-fade opacity="0.04">
        ...
        <polygon points="700,0 715,300 685,300" fill="var(--primary)" />
